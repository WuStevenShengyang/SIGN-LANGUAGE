...
delete = cv.imread("deleteC.png")
delete = cv.resize(delete,(100,62))
space = cv.imread("space.png")
...
def write():
    ...
    while True:
        ...
        if score>0.7 and res !="Delete" and res != "Space":
            cv.putText(write, res, (410, 490), font, 3, (0, 0, 0), 20)
            letterNow = res
        elif score>0.7 and res =="Delete" and res !="Space":
        ...
        if index >=20 and res != "Delete" and res !=  "Space":
            sentence += res
            index = 0
